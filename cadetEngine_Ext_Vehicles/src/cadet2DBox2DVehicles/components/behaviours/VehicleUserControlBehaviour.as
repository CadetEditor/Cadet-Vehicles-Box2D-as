...
package cadet2DBox2DVehicles.components.behaviours
{
	...
	public class VehicleUserControlBehaviour extends Component implements ISteppableComponent
	{
		...
		[Serializable][Inspectable]
		public var steeringEaseUp	:Number = 1;
		[Serializable][Inspectable]
		public var steeringEaseDown	:Number = 1;
		[Serializable][Inspectable]
		public var accelerationEaseUp:Number = 1;
		[Serializable][Inspectable]
		public var accelerationEaseDown:Number = 1;
		[Serializable][Inspectable]
		public var brakeEaseUp		:Number = 1;
		[Serializable][Inspectable]
		public var breakEaseDown	:Number = 1;
		
		public function VehicleUserControlBehaviour( name:String = "VehicleUserControlBehaviour" )
		{
			super(name);
		}
